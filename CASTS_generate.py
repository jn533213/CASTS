...
path['path19'] = directory+'Data_Input/WOD/2008_2018/netcdf_files/UOR/' #World Ocean Database, 2008-2012, UOR
path['path20'] = directory+'Data_Input/Argo_Float/data_processed/' #ARGO, 2000-2025
path_source = {}
...
path_source['path19'] = 'WOD'
path_source['path20'] = 'ARGO'
